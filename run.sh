...
# 训练
python -u $script_dir/main.py --gpu-id 5 --mode Train --arch GGNNNER --criterion SLLoss \
 --char-embed-dim 0 --gnn-steps 1 --save-dir checkpoint/GGNNNER_5 --w2v-dir data/process/w2v_300d.txt \
 --data-dir data/prepare/train.pkl --optimizer adadelta --lr 1 --evaluation f0.5 \
