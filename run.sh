...
python scripts/genGraph.py --mode 1 --input data/process/pretrain.dev.20K --output data/process/pretrain.dev.graph --process data/process/pretrain.dev.ic --stanford data/stanford-corenlp-full-2018-10-05
