...
# tokenize标签数据
#python scripts/mytokenize.py --mode 0 --input data/orign_data/fce-public.train.original.tsv --output data/process/fce-public.train.preprocess.tsv --stanford data/stanford-corenlp-full-2018-10-05
#python scripts/mytokenize.py --mode 0 --input data/orign_data/fce-public.dev.original.tsv --output data/process/fce-public.dev.preprocess.tsv --stanford data/stanford-corenlp-full-2018-10-05
#python scripts/mytokenize.py --mode 0 --input data/orign_data/fce-public.test.original.tsv --output data/process/fce-public.test.preprocess.tsv --stanford data/stanford-corenlp-full-2018-10-05

# 生成标签数据的依赖图
python scripts/genGraph.py --mode 0 --input data/process/fce-public.train.preprocess.tsv --output train_graph.txt --stanford data/stanford-corenlp-full-2018-10-05
python scripts/genGraph.py --mode 0 --input data/process/fce-public.dev.preprocess.tsv --output dev_graph.txt --stanford data/stanford-corenlp-full-2018-10-05
python scripts/genGraph.py --mode 0 --input data/process/fce-public.test.preprocess.tsv --output test_graph.txt --stanford data/stanford-corenlp-full-2018-10-05
