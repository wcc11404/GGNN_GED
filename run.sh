...
#python $script_dir/myscripts/genGraph.py --mode 1 --input data/process/pretrain.train.1M --output data/process/pretrain.train.1M.graph --process data/process/pretrain.train.1M.ic --stanford data/stanford-corenlp-full-2018-10-05
#python $script_dir/myscripts/genGraph.py --mode 1 --input data/process/pretrain.dev.20K --output data/process/pretrain.dev.20K.graph --process data/process/pretrain.dev.20K.ic --stanford data/stanford-corenlp-full-2018-10-05
...
# --char-embed-dim 0 --gnn-steps 3 --save-dir checkpoint/LM_GGNN \
...
# fine-tune
#python $script_dir/main.py --gpu-id 0 --mode Train --arch GGNNNER \
...
# 训练
python $script_dir/main.py --gpu-id 2 --mode Train --arch GGNNNER --w2v-dir data/process/w2v_300d.txt \
 --char-embed-dim 0 --gnn-steps 1 --save-dir checkpoint/GGNN_att_sl_lr2 \
 --data-dir data/prepare/train.pkl --optimizer adadelta --lr 2 --evaluation f0.5 \
 --batch-size 32 --early-stop 5 --max-epoch 50 --lm-cost-weight 0.1
