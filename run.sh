...
# 训练 adadelta
python -u $script_dir/main.py --gpu-id 0 1 2 3 --mode Train --arch GANNER --criterion BaseLoss \
 --char-embed-dim 0 --gnn-steps 1 --save-dir checkpoint/GAN_step3 --w2v-dir data/process/w2v_300d.txt \
 --data-dir data/prepare/train.pkl --optimizer adam --lr 5e-3 --evaluation f0.5 \
 --batch-size 32 --early-stop 8 --max-epoch 50 --lm-cost-weight 0.10 --use-ddp
